<?php
    ...
    while(have_posts()){
        ...
        <div class="metabox metabox--position-up metabox--with-home-link">
                <p>
                    <a class="metabox__blog-home-link" href="<?php echo get_post_type_archive_link('notice');?>">
                        所有须知
                    </a> 
            ...
            <div class="generic-content">
                ...
                <!--div class="pdf-embed-container" data-url="<?php //echo $file_download;?>">
                    < class="pdfjs-viewer"声明为pdf浏览器，千万别动，要装插件 >
                </div-->
            </div>
        </div>
    <?php }
